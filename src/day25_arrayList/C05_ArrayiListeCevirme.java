...
public class C05_ArrayiListeCevirme {
    public static void main(String[] args) {
        ...
        Integer [] arr= {1,3,4,6,7,1, 3,8,5,2,3,4,9,0 };
       ...
       // Arrays classi bize verilen array'i List'e ceviren hazir bir method sunuyor

      //  ANCAKKKK

      //  Bu methodu kullanarak bir array'i Liste cevirmenin 2 buyuk dezavantaji vardir
    ...
    //        ANCAKKKKK
    //        bu method'u kullanarak bir    birinde yapilan degisiklik, digerine de islenir
        //    //     */
        //    //    List<Integer> hazirMethodList = Arrays.asListarray'i list'e cevirmenin 2 buyuk dezavantaji var
