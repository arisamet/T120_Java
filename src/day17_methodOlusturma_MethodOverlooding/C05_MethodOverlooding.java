...
public class C05_MethodOverlooding {

    public static void main(String[] args) {

        String str = "Java gun gectikce guzellesiyor";
//Method overlooding olan bir classda hangi methodun calisacagina karar vermek icin
              //  asagidaki siralamaya gore methodlar incelenir.
        // 1-isim
        // 2- Paramete sayisi
